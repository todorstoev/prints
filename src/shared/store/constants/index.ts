...
export const SET_NOTIFIACTION_PERMISSION = '@options/SET_NOTIFIACTION_PERMISSION';
export const SET_IS_CLOUD_MESSAGE_TOKEN_VALID = '@options/SET_IS_CLOUD_MESSAGE_TOKEN_VALID';
